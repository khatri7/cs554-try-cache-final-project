				...
				{({ values, setFieldValue, isSubmitting }) => (
					<Stack gap={3}>
						...
						<FormHelperText sx={{ mt: -2 }}>
							* Include some details about your application here that will help
							your application. Such as number of tenants, your occupation,
							reviews, etc
						</FormHelperText>
						...
						<FormHelperText sx={{ mt: -2 }}>
							* Use this to include a single merged document of any documents
							you would like to attach with your application to make it stronger
							and/or for any documents asked by the lessor in description.
						</FormHelperText>
						<input
							ref={fileUploadRef}
							type="file"
